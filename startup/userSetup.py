...
def display_error(msg):
    ix.application.log_error(str("Shotgun Error | Clarisse engine | %s " % msg))


def display_warning(msg):
    ix.application.log_warning(str("Shotgun Warning | Clarisse engine | %s " % msg))


def display_info(msg):
    ix.application.log_info(str("Shotgun Info | Clarisse engine | %s " % msg))
