...
class MenuGenerator(object):
    ...
    def destroy_menu(self):
        """
        Destroys the entire Shotgun menu
        """
        self._menu_handle.remove_all_commands()
    ...
    def _add_menu_item(self, name, parent_menu_name, callback):
        ...
        item = self._main_menu_handle.add_command_as_script(
            "ScriptingPython3",
            #use "ScriptingPython" in Python2
            menu_item,
    ...
    def _add_context_menu(self):
        ...
        ctx_menu = self._add_sub_menu("Current Context", self._menu_name)
        self._add_menu_item(ctx_name, ctx_menu, self._current_context)
